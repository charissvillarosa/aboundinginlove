...
// http://javascript-source.com
//***********************************************
jQuery("#wowslider-container1").wowSlider({effect:"kenburns",prev:"",next:"",duration:1*100,delay:15*100,width:640,height:360,autoPlay:true,playPause:true,stopOnHover:false,loop:false,bullets:0,caption:true,captionEffect:"slide",controls:true,onBeforeStep:function(i,c){return (i+1 + Math.floor((c-1)*Math.random()))},images:[{src:"./image1.jpg",title:"Image 1",descr:"Description"},{src:"./image2.jpg",title:"Image 2",descr:"Description"},{src:"./image3.jpg",title:"Image 3",descr:"Description"},{src:"./image4.jpg",title:"Image 4",descr:"Description"}]});